...
var attachCodeHighlight = (host, options = {}) => {
	...
	const inplace = isCapacitorNative() && !(host instanceof HTMLTextAreaElement) && !host.isContentEditable;
	...
	const wrapped = {
		...
		disconnect: () => {
			...
			unbindKeys();
			host.classList.remove("code-highlight-painted", "code-highlight-inplace", "code-highlight-placeholder");
