...
var extractDocx = async (file) => {
	const mammothModule = await __vitePreload(() => import("../vendor/mammoth.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)), __vite__mapDeps([8,1,9,10,11,12,13,14]), import.meta.url);
...
var extractXlsx = async (file) => {
	const xlsxModule = await __vitePreload(() => import("../vendor/xlsx.js").then((n) => n.t), __vite__mapDeps([15,1]), import.meta.url);
