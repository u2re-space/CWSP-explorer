...
import { $ as resolveFsBackend, An as __vitePreload, En as navigate, On as M, Q as listVirtualRootEntriesFromRouter, Sn as vector2Ref, Tn as registerModal, hn as elementPointerMap, qt as handleIncomingEntries, rn as pointerAnchorRef, s as installLauncherBackStack, t as home_host_apply_default, vt as getWallpaperStoragePointer, x as openUnifiedContextMenu, xn as H, xt as setAppWallpaperFromBlob } from "../com/app.js";
...
import { DOMMixin, MOCElement, ensureVirtualKeyboardOverlay, getCorrectOrientation, isInFocus, loadAsAdopted, orientationNumberMap, preloadStyle, updateVP } from "/fest/dom.js";
...
async function resolveLauncherBridgeForSpeedDial() {
	...
	try {
		return await __vitePreload(() => import("./launcher-bridge.js"), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url);
	} catch {
		return null;
	}
}
