...
var openShellImageInViewer = async (file) => {
	...
	}, __vite__mapDeps([10,11,1,12,3,13,14,15,16,17]), import.meta.url);
		...
		(async () => {
			try {
				const { loadSettings } = await __vitePreload(async () => {
					...
					return { loadSettings };
				}, __vite__mapDeps([18,1,3,19,20,12,21,22,23,15,11,24,16]), import.meta.url);
				...
				}, __vite__mapDeps([15,1,11]), import.meta.url);
