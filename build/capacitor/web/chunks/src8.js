...
var registerOpenFilesSettingsContribution = () => registerSettingsContribution({
	...
	render: (ctx) => {
		...
		if (showSurface(ctx, "explorer")) blocks.push(...section("Explorer", "Open / click is the default. A file-type row overrides it only when that row is not “Follow default”. Capacitor Explorer has no in-app viewer — Display / Markdown here still open CWSP-document.", [
