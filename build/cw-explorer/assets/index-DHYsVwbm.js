const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../vendor/jsox.js","../chunks/rolldown-runtime.js","../chunks/vite-preload-DHlaQ_oz.js","../com/app.js","../vendor/@capacitor_core2.js"])))=>i.map(i=>d[i]);
...
var bootExplorerSku = async (container, kind) => {
	...
	__vitePreload(() => import("../vendor/jsox.js").then((n) => n.t).then((m) => m.ensureRemoteMountedFs()), __vite__mapDeps([0,1,2,3]), import.meta.url).catch(() => {});
