const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/capacitor-share-intent2.js","../chunks/vite-preload-DHlaQ_oz.js","../chunks/multi-value-list.js","../chunks/capacitor-permissions3.js","../chunks/capacitor-clipboard-asset2.js","../com/app4.js","../chunks/rolldown-runtime.js","../chunks/frontend-debug-capture2.js","../vendor/@capacitor_core.js","../chunks/UniformInterop2.js","../chunks/names.js","../chunks/airpad-cwsp-client-parity.js","../vendor/@capacitor_core2.js","../chunks/sw-handling.js","../chunks/ecosystem-skus.js","../chunks/UnifiedMessaging.js","../chunks/UniformInterop.js","../chunks/ShareTargetGateway.js","../chunks/UnifiedMessaging2.js","../chunks/core.js","../chunks/templates.js","../chunks/sw-unwrap.js","../vendor/jsox.js","../com/app.js","../vendor/jsox2.js","../chunks/remote-connection-runtime.js","../chunks/open-policy.js","../chunks/SettingsTypes.js","../chunks/process-ingress.js","../chunks/sku-ingress.js","../chunks/log-sanitizer.js","../chunks/ViewTransferRouting.js","../chunks/workcenter-command-wire.js","../chunks/crx-control-session.js","../chunks/launcher-bridge.js","../chunks/clipboard-device.js","../chunks/hub-socket-boot.js","../chunks/packet-wire-hash.js","../chunks/ecosystem-skus2.js","../chunks/cws-bridge.js","../chunks/Theme.js","../chunks/StateStorage.js","../chunks/Clipboard.js","../chunks/Runtime.js"])))=>i.map(i=>d[i]);
	...
	async boot(container, config) {
		...
		try {
			...
			if (isCapacitorCwsNativeShell()) {
				...
				__vitePreload(() => import("../com/app4.js").then((n) => n.m).then((mod) => mod.ensureNativeStorageProvide()), __vite__mapDeps([5,6,1]), import.meta.url).catch(() => void 0);
			}
			try {
			...
			if (!(() => {
				...
				}, __vite__mapDeps([13,14,6,10,1,15,16,17,18,19,20,9,21,22,23,24,8,11,2,25,26,27,28,29,30,31,32]), import.meta.url);
...
var registerCwspSettingsContribution = () => registerSettingsContribution({
	...
	load: (settings, panel) => {
		...
		if (crxStatus) __vitePreload(() => import("../chunks/crx-control-session.js").then((m) => m.formatCrxControlSessionStatus()), __vite__mapDeps([33,1]), import.meta.url).then((text) => {
...
var refreshInstalledSiblingSettingsSections = async () => {
	...
	inflight = (async () => {
		...
		try {
			...
			}, __vite__mapDeps([34,8,6,9,10,11,2]), import.meta.url);
...
var createSettingsView = (opts) => {
	...
	root.addEventListener("click", (e) => {
		...
		if (t?.closest?.("button[data-action=\"open-native-app-settings\"]")) {
			__vitePreload(() => import("../chunks/clipboard-device.js").then((n) => n.t).then((m) => m.openAppClipboardRelatedSettings()), __vite__mapDeps([35,6,1,8,9,10,11,2]), import.meta.url).then(() => setNote("App settings opened (native shell only).")).catch(() => setNote("Native settings unavailable in this context."));
			return;
		}
		if (t?.closest?.("button[data-action=\"open-native-notification-settings\"]")) {
			__vitePreload(() => import("../chunks/clipboard-device.js").then((n) => n.t).then((m) => m.openNativeNotificationSettings?.()), __vite__mapDeps([35,6,1,8,9,10,11,2]), import.meta.url).then(() => setNote("Notification settings opened (native shell only).")).catch(() => setNote("Native settings unavailable in this context."));
			return;
		}
		...
		if (crxPairBtn || crxUnpairBtn) {
			(async () => {
				...
				try {
					const m = await __vitePreload(() => import("../chunks/crx-control-session.js"), __vite__mapDeps([33,1]), import.meta.url);
					if (crxUnpairBtn) {
		...
		(async () => {
			...
			__vitePreload(() => import("../chunks/hub-socket-boot.js").then((n) => n.n).then(async (m) => {
				...
				}), __vite__mapDeps([36,6,8,9,10,11,2,37,1,22,23,38,39,16,12,25,35]), import.meta.url).catch(() => void 0);
			}), __vite__mapDeps([36,6,8,9,10,11,2,37,1,22,23,38,39,16,12,25,35]), import.meta.url);
			applyTheme$1(saved);
...
var SettingsView = class {
	...
	invokeChannelApi(action, payload) {
		if (action === SettingsChannelAction.Patch || action === SettingsChannelAction.SettingsUpdate) {
			...
			(async () => {
				try {
					const [{ loadSettings }, { applyTheme }] = await Promise.all([__vitePreload(() => import("../vendor/jsox2.js").then((n) => n.t), __vite__mapDeps([24,6,1,8,9,10,11,2,22,23,25,26,14,27,28]), import.meta.url), __vitePreload(() => import("../chunks/Theme.js").then((n) => n.t), __vite__mapDeps([40,6,1,22,23,24,8,9,10,11,2,25,26,14,27,28,41,42,43]), import.meta.url)]);
