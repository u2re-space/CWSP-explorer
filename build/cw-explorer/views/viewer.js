		...
		*/
		...
		async handleExportDocx() {
			...
			try {
				...
				}, __vite__mapDeps([9,1,2]), import.meta.url);
		...
		async navigateSingletonShell(viewId) {
			try {
				const { bootLoader } = await __vitePreload(async () => {
					...
					return { bootLoader };
				}, __vite__mapDeps([10,1,11,4,5,2,6,7,12,13]), import.meta.url);
...
//#endregion
export { createViewConstructor as C, ViewerChannelAction as S, sendViewProtocolMessage as _, flushHeldIngressToWorkCenter as a, HomeChannelAction as b, installShellImageOpenListener as c, peekHeldIngressFiles as d, refineLauncherImageIngress as f, takeHeldIngressFiles as g, sku_ingress_exports as h, dropHeldIngressFiles as i, isAndroidLocalShareUri as l, skuIngressHint as m, applyLauncherIngress as n, holdIngressFiles as o, registerWorkCenterFlushHost as p, dataUrlToFile as r, holdIngressFilesForPolicy as s, viewer_exports as t, onHeldIngressFiles as u, ExplorerChannelAction as v, createViewState as w, SettingsChannelAction as x, HistoryChannelAction as y };
