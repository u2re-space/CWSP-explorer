...
const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./src7.js","../shells/boot-index.js","./rolldown-runtime.js","../shells/boot-history-base.js","../com/app.js","../com/service.js","../fest/veela.js","./frontend-debug-capture.js","./src8.js","./capacitor-permissions.js","./capacitor-settings-permissions.js","../views/viewer.js","./admin-doors.js","./CustomInstructions.js","./utils.js","./src.js","./src9.js","./src5.js","./transfer-history-runtime.js","./src10.js","./WorkCenter.js","./log-sanitizer.js","./ShareTargetGateway.js","./entities.js","../vendor/@toon-format_toon.js","./unified.js","./RuntimeSettings.js","./WorkCenterState.js","./src4.js","./src6.js","./launcher-state.js"])))=>i.map(i=>d[i]);
import { n as initBootShellWindowActivity } from "../shells/preference.js";
import { mr as isEnabledView } from "../shells/boot-index.js";
import { Fn as hasActiveCloseable, Mt as restoreWallpaperThemeCache, Ot as initializeAppCanvasLayer, Pn as closeHighestPriority, kt as refreshAppWallpaperPaint } from "../com/app.js";
...
var CWSP_VIEW_LOADERS = {
	...
	settings: () => __vitePreload(() => import("./src8.js"), __vite__mapDeps([8,3,2,1,4,5,6,9,10,11,12,13,14]), import.meta.url),
	explorer: () => __vitePreload(() => import("./src.js"), __vite__mapDeps([15,3,2,1,4,5,6,11]), import.meta.url),
	viewer: () => __vitePreload(() => import("./src9.js"), __vite__mapDeps([16,3,2,1,4,5,6,11]), import.meta.url),
	markdown: () => __vitePreload(() => import("./src9.js"), __vite__mapDeps([16,3,2,1,4,5,6,11]), import.meta.url),
	history: () => __vitePreload(() => import("./src5.js"), __vite__mapDeps([17,4,2,11,3,1,5,6,18]), import.meta.url),
	workcenter: () => __vitePreload(() => import("./src10.js"), __vite__mapDeps([19,3,2,4,11,1,5,6,20,21,22,14,13,23,24,25,26,27]), import.meta.url),
	editor: () => __vitePreload(() => import("./src4.js"), __vite__mapDeps([28,3,2,4,11,1,5,6]), import.meta.url),
	home: () => __vitePreload(() => import("./src6.js"), __vite__mapDeps([29,4,2,6,11,3,1,5,30]), import.meta.url)
};
...
async function seedCwspLauncherTiles() {
	try {
		const mod = await __vitePreload(() => import("./launcher-state.js").then((n) => n.j), __vite__mapDeps([30,2,4]), import.meta.url);
...
var EnvironmentShell = class extends ShellBase {
	...
	*/
	...
	mountHomeDesktop(homeMount, shellContext) {
		mountViewModule(() => __vitePreload(() => import("./src6.js"), __vite__mapDeps([29,4,2,6,11,3,1,5,30]), import.meta.url), homeMount, { shellContext }).then((unmount) => {
