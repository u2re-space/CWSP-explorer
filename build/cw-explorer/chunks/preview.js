...
import { lr as isEnabledView } from "../shells/boot-index.js";
...
var MinimalShell = class extends ShellBase {
	...
	*/
	renderView(element) {
		...
		if (previousId && previousId !== this.currentView.value && this.loadedViews.has(previousId)) {
			...
			if (previousId === "history" && this.currentView.value !== "history") try {
				if (globalThis.__CWSP_TRANSFER_HISTORY_UI_ACTIVE__) __vitePreload(() => import("./transfer-history-runtime.js").then((m) => m.setTransferHistoryUiActive(false)), __vite__mapDeps([7,4,1]), import.meta.url).catch(() => void 0);
			} catch {}
		}
	...
	flushShownView(element) {
		...
		__vitePreload(() => import("../com/app.js").then((n) => n.jt).then((m) => {
