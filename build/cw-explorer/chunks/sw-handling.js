const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./BootLoader.js","./rolldown-runtime.js","../com/app.js","../fest/core.js","../shells/preference.js","../shells/boot-history-base.js","../shells/boot-index.js","../com/service.js","../fest/veela.js","./capacitor-settings-permissions.js","./capacitor-permissions.js","./RuntimeSettings.js","./sku-ingress.js"])))=>i.map(i=>d[i]);
import { At as isBase64Like, Mn as __vitePreload, Mt as parseDataUrl, Qt as initClipboardReceiver, Zt as copy, pt as bindDirectoryForLaunchedFiles } from "../com/app.js";
		...
		(async () => {
			if (shareId) try {
				...
				if (res.ok) {
					...
					}, __vite__mapDeps([12,2,1,5]), import.meta.url);
					const files = [];
