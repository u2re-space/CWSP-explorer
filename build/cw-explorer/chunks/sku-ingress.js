...
var loadLauncherState = () => __vitePreload(() => import("../com/app3.js").then((n) => n.f), __vite__mapDeps([2,1,3,4,5,6,7]), import.meta.url);
...
var applyLauncherIngress = async (payload) => {
	...
	if ((payload.action === "wallpaper" || !payload.action) && image && await isWallpaperCompatible(image)) {
		...
		}, __vite__mapDeps([8,1,4,3,5]), import.meta.url);
...
var openShellImageInViewer = async (file) => {
	...
	}, __vite__mapDeps([9,10,1,11,3,12,13,14,15,16]), import.meta.url);
		...
		(async () => {
			try {
				const { loadSettings } = await __vitePreload(async () => {
					...
					return { loadSettings };
				}, __vite__mapDeps([17,1,3,18,19,11,20,21,4,5,22,14,10,23,15]), import.meta.url);
				...
				}, __vite__mapDeps([14,1,10]), import.meta.url);
