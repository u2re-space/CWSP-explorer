...
const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./frontend-debug-capture.js","./rolldown-runtime.js","../shells/boot-index.js","../shells/boot-history-base.js","../com/service.js","../com/app.js","../fest/veela.js","./sw-handling.js","./LogSanitizer.js","./sku-ingress.js","./ViewTransferRouting.js"])))=>i.map(i=>d[i]);
import { r as __exportAll } from "./rolldown-runtime.js";
import { t as LS_BOOT_SHELL_LAST_ACTIVE } from "../shells/preference.js";
import { $t as getAirPadTransportMode, An as isFleetGatewayWireNodeId, B as isCapacitorNativeShell, Bn as shouldFleetDeskGatewayProbeFallbacks, F as packetWireDedupeGuard, Fn as isOnHomeFleetLanPageHost, G as applyTheme, Gt as applyAirpadRuntimeFromAppSettings, H as writeClipboardImageToDevice, Hn as CWSP_DEFAULT_HTTPS_PORTS, Ht as ensureCapacitorCwspSettingsSeeded, I as annotateCoordinatorPayload, In as normalizeWireNodeIdForWire, Jt as getAirPadDirectTargetUrl, Kt as getAccessToken, L as shouldAnnotateCoordinatorPayload, Ln as sanitizeFleetRouteTarget, M as ensureAppLayers, Mn as isGuestPrivateLanIpv4, Mr as serviceChannels, N as annotatePacketWireHash, Nn as isHomeFleetLanHost, On as isAssociableFleetWireNodeId, P as inferWireDedupeCategory, Pn as isOffHomeFleetNetwork, Qn as splitConnectHostList, Qt as getAirPadPeerInstanceId, R as annotatePacketWireTime64, Rn as sanitizeFleetSelfWireNodeId, Sn as invokeCwsNative, Tn as DEFAULT_DESK_WIRE_NODE_ID, U as writeClipboardTextToDevice, Un as CWSP_DEFAULT_HTTP_PORTS, Ut as loadSettings, V as readClipboardTextFromDevice, Vn as shouldPreferWanGatewayForAirpad, W as loadStyleSystem, Wt as shouldDeferCrxHubSocketBootstrap, Xt as getAirPadHandshakeArchetype, Yt as getAirPadEndpointUrl, Zt as getAirPadHandshakeConnectionType, _n as DEFAULT_SETTINGS, an as getRemoteHost, ar as darkTheme, cn as isApplyRemoteClipboardToDeviceEnabled, cr as lightTheme, dn as isMaintainHubSocketConnectionEnabled, dr as startImplicitViewMessagingBridge, en as getAirPadTransportSecret, fn as isNeutralinoNodeClipboardHubOwned, gn as setAirpadCredentialInvalidator, hn as isShellRemoteClipboardBridgeEnabled, in as getClipboardPushIntervalMs, jn as isGatewayHttpsOrigin, kn as isFleetDeskWireNodeId, ln as isClipboardHubBootstrapEnabled, lr as isEnabledView, mn as isPushLocalClipboardToLanEnabled, nn as getClientAccessToken, nr as initializeLayers, on as getRemoteProtocol, or as defaultTheme, pn as isPreferNativeWebsocketEnabled, qt as getAirPadClientId, rn as getClipboardBroadcastWireTargets, rr as ShellRegistry, sn as getRemoteRouteTarget, sr as initializeRegistries, tn as getAssociatedClientToken, un as isClipboardSenderAllowedForInbound, ur as pickEnabledView, wn as isCapacitorCwsNativeShell, xn as initCwsNativeBridge, zn as shouldConnectViaFleetGateway } from "../shells/boot-index.js";
