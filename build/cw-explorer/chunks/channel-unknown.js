...
import { $ as ensureStyleSheet, En as __vitePreload, Lt as createTemplateManager, On as loadAsAdopted, Q as testIconRacing, X as clearIconCaches, Z as debugIconSystem, dt as getCachedComponent, et as reinitializeRegistry, nn as H, tt as clearAllCache, xt as createFileHandler, zt as getSpeechPrompt } from "../com/app.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => __vitePreload(() => import("../com/app.js").then((n) => n.Ht), __vite__mapDeps([2,1]), import.meta.url), { componentName: "HistoryManager" })).component.createHistoryManager();
