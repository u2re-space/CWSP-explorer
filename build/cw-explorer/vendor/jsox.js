const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../com/app.js","../chunks/rolldown-runtime.js","../chunks/vite-preload-DHlaQ_oz.js"])))=>i.map(i=>d[i]);
...
var getNativeBackend = () => {
	nativeBackendPromise ??= __vitePreload(async () => {
		const { readFile, removeFile, writeFile } = await import("../com/app.js").then((n) => n.t);
		return {
			readFile,
			removeFile,
			writeFile
		};
	}, __vite__mapDeps([0,1,2]), import.meta.url).then(({ readFile, removeFile, writeFile }) => ({
		async read(path) {
