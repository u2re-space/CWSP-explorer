const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/crx-control-session.js","../chunks/vite-preload-DHlaQ_oz.js","./jsox.js","../chunks/rolldown-runtime.js","../com/app.js"])))=>i.map(i=>d[i]);
...
//#region ../CWSP-document/node_modules/jsox/lib/jsox.mjs
var _JSON = JSON;
/**
...
var loadLureFs = () => {
	...
	if (!lureFsPromise) lureFsPromise = __vitePreload(() => import("./jsox.js").then((n) => n.t).then((m) => ({
