...
import { Hn as splitMultiValueList } from "../shells/boot-index.js";
...
var installCapacitorShareIntentBridge = () => {
	...
	const handler = (ev) => {
		(async () => {
			...
			try {
				const [{ loadSettings }, ws] = await Promise.all([__vitePreload(() => import("../shells/boot-index.js").then((n) => n.$), __vite__mapDeps([0,1,2,3,4,5]), import.meta.url), __vitePreload(() => import("../shells/boot-index.js").then((n) => n.c), __vite__mapDeps([0,1,2,3,4,5]), import.meta.url)]);
