const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./app2.js","../chunks/rolldown-runtime.js","../chunks/vite-preload-DHlaQ_oz.js"])))=>i.map(i=>d[i]);
...
var getNativeBackend = () => {
	nativeBackendPromise ??= __vitePreload(async () => {
		const { readFile, removeFile, writeFile } = await import("./app2.js").then((n) => n.t);
		return {
			readFile,
			removeFile,
			writeFile
