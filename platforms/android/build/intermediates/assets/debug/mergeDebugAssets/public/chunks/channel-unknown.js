...
import { cr as initializeComponent, gr as BROADCAST_CHANNELS, ir as createMessageWithOverrides, it as loadSettings, lr as processInitialContent, nr as settleIngressPaintForMinimalShell, or as enqueuePendingMessage, pr as unifiedMessaging, sr as hasPendingMessages, ur as registerComponent, vr as getBroadcastChannelForDestination } from "../shells/boot-index.js";
...
import { $t as getSpeechPrompt, Ft as createFileHandler, Tn as __vitePreload, Zt as createTemplateManager, bt as getCachedComponent, gn as H } from "../com/app.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => __vitePreload(() => import("../com/app.js").then((n) => n.nn), __vite__mapDeps([5,1]), import.meta.url), { componentName: "HistoryManager" })).component.createHistoryManager();
