...
var ensureNativeStorageProvide = async () => {
	...
	try {
		...
		const { registerMarkdownFilePicker } = await __vitePreload(async () => {
			const { registerMarkdownFilePicker } = await import("./app3.js").then((n) => n.s);
			return { registerMarkdownFilePicker };
		}, __vite__mapDeps([5,1,4,2]), import.meta.url);
