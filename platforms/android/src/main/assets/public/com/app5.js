const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./app.js","../chunks/rolldown-runtime.js","../chunks/vite-preload-DHlaQ_oz.js","../vendor/jsox.js","./app2.js","./app3.js"])))=>i.map(i=>d[i]);
import { r as __exportAll } from "../chunks/rolldown-runtime.js";
import { t as __vitePreload } from "../chunks/vite-preload-DHlaQ_oz.js";
import { t as JSOX } from "../vendor/jsox.js";
import { S as loadDesktopRaw, b as saveUIState, x as decodeDesktopState, y as makeUIState } from "./app.js";
import { W as registerDirectoryRoot, Z as unregisterDirectoryRoot } from "./app2.js";
import { C as normalizeVirtualPath, d as readNativeStorageFile, f as removeNativeStorage, o as isNativeStorageAvailable, s as listNativeStorage, w as resolveEntryIcon } from "./app6.js";
...
var loadIdbRoot = async () => {
	...
	try {
		const { getIdbRoot } = await __vitePreload(async () => {
			const { getIdbRoot } = await import("./app.js").then((n) => n.t);
			return { getIdbRoot };
...
function ensureDefaultFsBackends() {
	...
	if (isOpfsBackendActiveSync() && typeof indexedDB !== "undefined") {
		...
		__vitePreload(async () => {
			const { unregisterProvideBackend } = await import("./app.js").then((n) => n.t);
		...
		async list(path) {
			try {
				const { tryRemoteMountedList } = await __vitePreload(async () => {
					const { tryRemoteMountedList } = await import("./app.js").then((n) => n.t);
		...
		async readFile(path) {
			...
			try {
				const { tryRemoteMountedRead } = await __vitePreload(async () => {
					const { tryRemoteMountedRead } = await import("./app.js").then((n) => n.t);
	...
	__vitePreload(async () => {
		const { ensureRemoteMountedFs } = await import("./app.js").then((n) => n.t);
