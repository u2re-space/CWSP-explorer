const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../vendor/@capacitor_core.js","./rolldown-runtime.js","./UniformInterop2.js","./names.js","./airpad-cwsp-client-parity.js","./multi-value-list.js","../vendor/culori.js","../com/app.js","./vite-preload-DHlaQ_oz.js","../vendor/jsox.js","../com/app2.js","../com/app3.js"])))=>i.map(i=>d[i]);
...
import { X as Q } from "../com/app.js";
import { D as isEnabledView, E as ENABLED_VIEW_IDS, b as ViewRegistry, f as applyGridSettings } from "../assets/index-DHkxbR3V.js";
...
var extractFromImage = async (src) => {
	try {
		...
		}, __vite__mapDeps([6,1,7,8,9,10,11]), import.meta.url);
...
var resumeThemeAfterForeground = (force = false) => {
	...
	(async () => {
		try {
			...
			}, __vite__mapDeps([7,1,8,9,10,11]), import.meta.url);
