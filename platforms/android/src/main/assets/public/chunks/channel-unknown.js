...
import { $ as ensureStyleSheet, Bt as createTemplateManager, Ht as getSpeechPrompt, Q as testIconRacing, X as clearIconCaches, Z as debugIconSystem, an as H, dt as getCachedComponent, et as reinitializeRegistry, jn as loadAsAdopted, kn as __vitePreload, tt as clearAllCache, wt as createFileHandler } from "../com/app.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => __vitePreload(() => import("../com/app.js").then((n) => n.Gt), __vite__mapDeps([2,1]), import.meta.url), { componentName: "HistoryManager" })).component.createHistoryManager();
