const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../chunks/launcher-bridge.js","../vendor/@capacitor_core.js","../chunks/rolldown-runtime.js","../chunks/UniformInterop2.js","../chunks/names.js","../chunks/airpad-cwsp-client-parity.js","../chunks/multi-value-list.js","../com/app6.js","../chunks/vite-preload-DHlaQ_oz.js","../com/app.js","../vendor/jsox.js","../com/app2.js","../com/app3.js","../com/app7.js","../com/app4.js","../com/app5.js"])))=>i.map(i=>d[i]);
...
import { L as defineElement, R as property, T as initGlobalClipboard, Z as bindWith, z as H } from "../com/app.js";
import { g as getDir } from "../com/app2.js";
import { _ as speedDialItems, d as addSpeedDialItem, g as persistSpeedDialMeta, h as persistSpeedDialItems, m as ensureSpeedDialMeta, p as createEmptySpeedDialItem } from "../assets/index-DHkxbR3V.js";
import { a as sortExplorerEntries, c as openUnifiedContextMenu, d as formatDate, f as formatSize, h as isBookmarksPath, i as peekExplorerSort, l as entryKey, m as FileOperative, n as openExplorerSettings, p as iconFor, r as EXPLORER_SORT_EVENT, s as createItemCtxMenu, t as closeExplorerSettings, u as entryKind, x as __decorate, y as UIElement } from "../com/app4.js";
import { A as resolveFsBackend, O as ensureDefaultFsBackends } from "../com/app5.js";
import { T as toExplorerStoragePath, w as resolveEntryIcon } from "../com/app6.js";
...
var nativeViewUri = async (sourcePath) => {
	...
	try {
		const { resolveNativeStorageUri } = await __vitePreload(async () => {
			const { resolveNativeStorageUri } = await import("../com/app6.js").then((n) => n._);
...
function loadLastPath(explorer, initialPath) {
	try {
		...
		__vitePreload(() => import("../com/app.js").then((n) => n.t).then((m) => m.ensureRemoteMountedFs()), __vite__mapDeps([9,2,8,10,11,12]), import.meta.url).catch(() => {});
	} catch {}
	...
	const ensureItemFile = async (item, sourcePath) => {
		...
		if (!item.file) try {
			const { provide } = await __vitePreload(async () => {
				...
				return { provide };
			}, __vite__mapDeps([9,2,8,10,11,12]), import.meta.url);
...
function wireExplorerSubtree(shellRoot, wireOpts) {
	...
	if (fm) {
		...
		__vitePreload(() => import("../com/app7.js").then((n) => n.n).then((m) => m.installExplorerBackStack()), __vite__mapDeps([13,2,9,8,10,11,12,14,15,7]), import.meta.url).catch(() => {});
		return {
			cleanup: () => {
